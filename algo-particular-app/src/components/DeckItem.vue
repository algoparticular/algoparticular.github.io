<template>
    ...
    <div class="deckItem untap" @click="loadCard()" v-else>
...
<style>
    .deckItem {
        border: 2px solid rgba(54, 54, 54, 0.42 );
        filter: drop-shadow(0px 2px 3px rgba(16, 16, 15, 1));
        border-radius: 18px;
        width: 90px;
        height: 90px;
    ...
    @keyframes pulse-bg {
        ...
        25% {
            border: 2px solid rgba(54, 54, 54, 0.27 );
        }
        50% {
