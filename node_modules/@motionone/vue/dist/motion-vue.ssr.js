...
}const isCubicBezier = easing => Array.isArray(easing) && isNumber(easing[0]);const isEasingGenerator = easing => typeof easing === "object" && Boolean(easing.createAnimation);const isFunction = value => typeof value === "function";const time = {
